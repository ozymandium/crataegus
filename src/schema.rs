...
pub mod location {
    ...
    pub enum Source {
        ...
        GpsLogger,
        /// EXIF GPS data. Local time is generated by looking up the timezone from the GPS data.
        /// Intended to be harvested from photos/videos taken with a camera while GPSLogger was
        /// not active.
